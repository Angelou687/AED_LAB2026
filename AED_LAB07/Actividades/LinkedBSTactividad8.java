...
public class LinkedBST<E extends Comparable<E>> implements BinarySearchTree<E> {
    ...
    // --- ACTIVIDAD 8: Recorrido Pre-Orden (Raíz, Izquierda, Derecha) ---

    /**
     * Realiza el recorrido pre-orden de forma recursiva.
     */
    private void preOrder(Node<E> node, StringBuilder sb) {
        if (node != null) {
            sb.append(node.data).append(" "); // Procesar raíz
            preOrder(node.left, sb);          // Visitar izquierda
            preOrder(node.right, sb);         // Visitar derecha
        }
    }

    /**
     * Método público para obtener el recorrido Pre-Orden como String.
     */
