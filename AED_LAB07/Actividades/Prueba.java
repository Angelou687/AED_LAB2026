...
public class Prueba {
    public static void main(String[] args) {
        // Se especifica el tipo Integer para evitar advertencias de tipos crudos
        ...
        try {
            ...
            // El método toString() realiza un recorrido InOrder (8 10 12 15 17 20 25)
            ...
            arbol.search(100); // Esto lanzará la excepción ItemNotFound
        ...
        // Bloque de prueba para la destrucción del árbol
        try {
            System.out.println("\nDestruyendo árbol...");
            arbol.destroy();
            ...
            arbol.delete(15); // Esto lanzará ExceptionIsEmpty
        } catch (ExceptionIsEmpty e) {
            System.err.println("Excepción: " + e.getMessage());
        }
    }
